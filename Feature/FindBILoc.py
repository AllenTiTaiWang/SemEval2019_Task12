...
# extract location 
all_doc = {}
for filename in glob.glob(os.path.join(cwd, "Final_dataset/actual_dev/*.ann")):
...
#print("==========")
all_doc = doc_all
with open(os.path.join(cwd, "../data/all_doc.json"), "w") as fp:
    all_doc = json.dump(all_doc, fp)
