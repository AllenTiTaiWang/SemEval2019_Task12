...
with open(os.path.join(cwd, '../data/all_doc_test.json'), 'r') as fp:
...
with open(os.path.join(cwd, '../data/doc2country_test.json'), 'w') as fp:
    doc2country_test = json.dump(doc2country_test, fp)
