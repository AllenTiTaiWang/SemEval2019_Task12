...
# extract location 
all_doc = {}
for filename in glob.glob(os.path.join(cwd, "Final_dataset/Final_test/*.ann")):
...
#print(doc_all)
#print("==========")
all_doc_test = doc_all
with open(os.path.join(cwd, "../data/all_doc_test.json"), "w") as fp:
    all_doc_test = json.dump(all_doc_test, fp)
